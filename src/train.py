...
for batch_size, subset_ratio in itertools.product(batch_range, stab_ratio_range): 
        ...
        num_epochs = max(num_epochs, int(3000/iters_per_epoch))
        ...
        for experiment in range(num_experiments):
                ...
                x_val, y_val = data.validation.images, data.validation.labels.reshape(-1)
                ...
                dict_exp = utils_print.update_best_acc(args, best_model, x_test, y_test, x_val, y_val, experiment, dict_exp)
