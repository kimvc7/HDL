...
class Model(object):
	def __init__(self, num_classes, batch_size, cnn_size, pool_size, subset_ratio, num_features, dropout = 1, l2 = 0, l0 = 0, rho=0, image_size=None, ticket=False, stored_weights=None):
