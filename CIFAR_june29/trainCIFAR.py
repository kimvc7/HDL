...
parser.add_argument("--runnum", type=int, default=1, help='which gen param of 40 [0,39]')
...
possibleparams = [[0.001, 0.001, 128, 0.0001, 1024, 256, 0.85, 1e-07, 1],
 [0.001, 0.001, 128, 0.0001, 1024, 256, 0.85, 1e-08, 1],
 [0.001, 0.001, 128, 0.0001, 1024, 256, 1, 1e-07, 1],
 [0.001, 0.001, 128, 0.0001, 1024, 256, 1, 1e-08, 1],
 [0.01, 1e-05, 64, 0.0001, 1024, 256, 0.85, 1e-07, 1],
 [0.01, 1e-05, 64, 0.0001, 1024, 256, 0.85, 1e-08, 1],
 [0.01, 1e-05, 64, 0.0001, 1024, 256, 1, 1e-07, 1],
 [0.01, 1e-05, 64, 0.0001, 1024, 256, 1, 1e-08, 1],
 [0.01, 0.0, 64, 0.0001, 1024, 256, 0.85, 1e-07, 1],
 [0.01, 0.0, 64, 0.0001, 1024, 256, 0.85, 1e-08, 1],
 [0.01, 0.0, 64, 0.0001, 1024, 256, 1, 1e-07, 1],
 [0.01, 0.0, 64, 0.0001, 1024, 256, 1, 1e-08, 1],
 [0.001, 0.001, 64, 0.0001, 1024, 256, 0.85, 1e-07, 1],
 [0.001, 0.001, 64, 0.0001, 1024, 256, 0.85, 1e-08, 1],
 [0.001, 0.001, 64, 0.0001, 1024, 256, 1, 1e-07, 1],
 [0.001, 0.001, 64, 0.0001, 1024, 256, 1, 1e-08, 1],
 [0.01, 0.0, 128, 0.0001, 512, 256, 0.85, 1e-07, 1],
 [0.01, 0.0, 128, 0.0001, 512, 256, 0.85, 1e-08, 1],
 [0.01, 0.0, 128, 0.0001, 512, 256, 1, 1e-07, 1],
 [0.01, 0.0, 128, 0.0001, 512, 256, 1, 1e-08, 1],
 [0.01, 1e-05, 128, 0.0001, 512, 256, 0.85, 1e-07, 1],
 [0.01, 1e-05, 128, 0.0001, 512, 256, 0.85, 1e-08, 1],
 [0.01, 1e-05, 128, 0.0001, 512, 256, 1, 1e-07, 1],
 [0.01, 1e-05, 128, 0.0001, 512, 256, 1, 1e-08, 1],
 [0.01, 0.0001, 128, 0.0001, 512, 256, 0.85, 1e-07, 1],
 [0.01, 0.0001, 128, 0.0001, 512, 256, 0.85, 1e-08, 1],
 [0.01, 0.0001, 128, 0.0001, 512, 256, 1, 1e-07, 1],
 [0.01, 0.0001, 128, 0.0001, 512, 256, 1, 1e-08, 1],
 [0.01, 0.0, 128, 0.0001, 1024, 256, 0.85, 1e-07, 1],
 [0.01, 0.0, 128, 0.0001, 1024, 256, 0.85, 1e-08, 1],
 [0.01, 0.0, 128, 0.0001, 1024, 256, 1, 1e-07, 1],
 [0.01, 0.0, 128, 0.0001, 1024, 256, 1, 1e-08, 1],
 [0.01, 1e-05, 128, 0.0001, 1024, 256, 0.85, 1e-07, 1],
 [0.01, 1e-05, 128, 0.0001, 1024, 256, 0.85, 1e-08, 1],
 [0.01, 1e-05, 128, 0.0001, 1024, 256, 1, 1e-07, 1],
 [0.01, 1e-05, 128, 0.0001, 1024, 256, 1, 1e-08, 1],
 [0.01, 0.0001, 128, 0.0001, 1024, 256, 0.85, 1e-07, 1],
 [0.01, 0.0001, 128, 0.0001, 1024, 256, 0.85, 1e-08, 1],
 [0.01, 0.0001, 128, 0.0001, 1024, 256, 1, 1e-07, 1],
 [0.01, 0.0001, 128, 0.0001, 1024, 256, 1, 1e-08, 1]]
    
which_param = args.runnum
param_list = possibleparams[which_param]
...
args.batch_range = [param_list[2]]
args.lr = param_list[3]
args.l2 = param_list[1]
args.dropout = param_list[-3]
args.l1_size = param_list[-5]
args.l2_size = param_list[-4]

args.robust = param_list[0]
args.stable = 1
args.l0 = param_list[-2]
